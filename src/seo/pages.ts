...
export const seoPages: SeoPage[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Three minutes is also a practical length for checking progress more often than a long endurance test. Save the result, practice the specific issue it exposes, and compare again later under the same conditions."
    ],
    related: [
      { href: "/typing-practice/", label: "Typing Practice" },
  ...
  },
  {
    ...
    content: [
      ...
      "If you are preparing for an employment assessment, confirm whether the stated KPH score is gross or adjusted for errors and whether corrections are allowed during the test. Those details can change the meaning of the number. Do not assume a KPH target from one employer applies to another. Use the actual posting or assessment instructions as the standard, then practice with a similar duration and keypad setup so your preparation matches the task as closely as possible."
    ],
    related: [
      { href: "/data-entry-typing-test/", label: "Data Entry Typing Test" },
